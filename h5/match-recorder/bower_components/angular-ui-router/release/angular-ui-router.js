...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  var stateBuilder = {
    ...
    // Own parameters for this state. state.url.params is already built at this currentPoint. Create and add non-url params
  ...
  function findState(stateOrName, base) {
    ...
    if (path) {
      if (!base) throw new Error("No reference currentPoint given for path '"  + name + "'");
      base = findState(base);
...
function $StateRefActiveDirective($state, $stateParams, $interpolate) {
  return  {
    ...
    controller: ['$scope', '$element', '$attrs', '$timeout', function ($scope, $element, $attrs, $timeout) {
      ...
      // There probably isn't much currentPoint in $observing this
